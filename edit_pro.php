<?php 
include('condb.php');
$query = "SELECT * FROM tbl_type " or die("Error:" . mysqli_error());
...
<?php 
    ...
    if (isset($_REQUEST['btn_update'])) {
        try {
            ...
            $name_pro = $_REQUEST['txt_name_pro'];
            ...
            if (!isset($errorMsg)) {
                $update_stmt = $db->prepare("UPDATE tbl_file SET name_pro = :name_pro_up, image = :file_up, detail = :detail_up, price = :price_up WHERE id = :id");
                $update_stmt->bindParam(':name_pro_up', $name_pro);
                ...
                if ($update_stmt->execute()) {
                    ...
                    header("refresh:2;index_add.php");
                }
            }
...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="txt_name_pro" class="form-control" value="<?php echo $name_pro; ?>">
            </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                ...
                <a href="index_add.php" class="btn btn-danger">Cancel</a>
            </div>
        </div>
    </form>
    </div>
